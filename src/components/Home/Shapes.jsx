...
const Shapes = () => {
  return (
    <MouseParallaxContainer className='shapes' style={{ position: 'absolute' }}>
      <MouseParallaxChild className='shape s1' factorX={0.04} factorY={0.04}>
      ...
      <MouseParallaxChild className='shape s2' factorX={-0.05} factorY={-0.05}>
      ...
      <MouseParallaxChild className='shape s3' factorX={0.02} factorY={0.02}>
      ...
      <MouseParallaxChild className='shape s4' factorX={0.06} factorY={0.06}>
      ...
      <MouseParallaxChild className='shape s5' factorX={-0.05} factorY={-0.05}>
        <svg width='15' height='23' xmlns='http://www.w3.org/2000/svg'>
          <rect
            transform='rotate(30 9.86603 10.13397)'
            x='7'
      ...
      <MouseParallaxChild className='shape s6' factorX={0.06} factorY={0.06}>
      ...
      <MouseParallaxChild className='shape s7' factorX={0.08} factorY={0.08}>
        <svg width='26' height='26' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <MouseParallaxChild className='shape s8' factorX={-0.02} factorY={-0.02}>
      ...
      <MouseParallaxChild className='shape s9' factorX={0.04} factorY={0.04}>
        <svg width='30' height='25' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <MouseParallaxChild className='shape s10' factorX={-0.09} factorY={-0.09}>
      ...
      <MouseParallaxChild className='shape s11' factorX={-0.06} factorY={-0.06}>
