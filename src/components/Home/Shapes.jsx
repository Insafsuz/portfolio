...
const Shapes = () => {
  return (
    <MouseParallaxContainer className='shapes' style={{ position: 'absolute' }}>
      <MouseParallaxChild className='shape s1' factorX={0.05} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s2' factorX={0.07} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s3' factorX={0.09} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s4' factorX={0.07} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s6' factorX={0.05} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s7' factorX={0.05} factorY={0.05}>
        <svg width='26' height='26' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <MouseParallaxChild className='shape s8' factorX={0.05} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s9' factorX={0.05} factorY={0.05}>
        <svg width='30' height='25' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <MouseParallaxChild className='shape s10' factorX={0.05} factorY={0.05}>
      ...
      <MouseParallaxChild className='shape s11' factorX={0.05} factorY={0.05}>
